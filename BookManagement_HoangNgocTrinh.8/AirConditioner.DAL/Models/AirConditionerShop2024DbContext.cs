...
public partial class AirConditionerShop2024DbContext : DbContext
{
    ...
    public virtual DbSet<AirConditionerShop> AirConditioners { get; set; }
...
#warning To protect potentially sensitive information in your connection string, you should move it out of source code. You can avoid scaffolding the connection string by using the Name= syntax to read it from configuration - see https://go.microsoft.com/fwlink/?linkid=2131148. For more guidance on storing connection strings, see https://go.microsoft.com/fwlink/?LinkId=723263.
        => optionsBuilder.UseSqlServer("Server=DESKTOP-TC2CQM0\\KHOA;uid=sa;pwd=12345678;database=AirConditionerShop2024DB;TrustServerCertificate=True");

    protected override void OnModelCreating(ModelBuilder modelBuilder)
    {
        modelBuilder.Entity<AirConditionerShop>(entity =>
        {
            entity.HasKey(e => e.AirConditionerId).HasName("PK__AirCondi__EE2EB739824EF4AD");
        ...
        {
            entity.HasKey(e => e.MemberId).HasName("PK__StaffMem__0CF04B3818B2A926");

            entity.ToTable("StaffMember");

            entity.HasIndex(e => e.EmailAddress, "UQ__StaffMem__49A147402DA1909D").IsUnique();
        ...
        {
            entity.HasKey(e => e.SupplierId).HasName("PK__Supplier__4BE666B4D7D735BF");
