...
public partial class AirConditionerShop2024DbContext : DbContext
{
    ...
    private string GetConnectionString()
    {
        ...
        //COI CHỪNG 9 TRIỆU: 6T TIỀN HỌC + 3T HỌC LẠI; DẤU CÁCH GÂY NÊN 2 ATTRIBUTE KO KHỚP FILE JSON -> KO ĐỌC ĐC CHUỖI CONNECTOION STRING, CHUỖI KẾT NỐI CSDL
        //CHẤM BÀI KO ĐC!!!
    ...
    protected override void OnModelCreating(ModelBuilder modelBuilder)
    {
        ...
        {
            entity.HasKey(e => e.AirConditionerId).HasName("PK__AirCondi__EE2EB7398A98CE69");
        ...
        {
            entity.HasKey(e => e.MemberId).HasName("PK__StaffMem__0CF04B38408ED024");

            entity.ToTable("StaffMember");

            entity.HasIndex(e => e.EmailAddress, "UQ__StaffMem__49A147407EA7637A").IsUnique();
        ...
        {
            entity.HasKey(e => e.SupplierId).HasName("PK__Supplier__4BE666B4488D8DB6");
